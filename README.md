...
## Run Client
python3 -m dependency_scanner_tool.client_cli --poll-interval 3 scan https://github.com/openai/codex.git --csv-output deleteme2.csv
...
python3 -m dependency_scanner_tool.client_cli --poll-interval 1 scan https://github.com/psf/requests.git --csv-output deleteme2.csv
